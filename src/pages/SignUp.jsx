  ...
  return (
    ...
    >
      ...
      <div className="w-1/3 py-10  border-solid flex flex-col gap-8 align-middle justify-center border-white bg-black bg-opacity-50 shadow-lg rounded-lg z-10 relative px-10">
        ...
        <div className="flex flex-row align-middle justify-center gap-5" onClick={()=>{
          handleSubmit();
        }}>
        ...
        <span className="text-orange-400">Already have account? <Link className="text-blue-300 hover-underline-animation" to="/sign-in">
            Sign-in Here
          </Link></span>
        </div>
      </div>
